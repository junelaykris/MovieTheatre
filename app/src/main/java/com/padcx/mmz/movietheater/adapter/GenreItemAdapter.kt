 ...
 */
class GenreItemAdapter(private val mDelegate: PopularMovieListActionDelegate):
    BaseRecyclerAdapter<PopularMovieViewHolder, PopularMovieVO>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PopularMovieViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.popular_films_serials_items,parent,false)
